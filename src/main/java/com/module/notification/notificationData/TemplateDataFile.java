...
public class TemplateDataFile implements TemplateDataInterface {
    ...
    public void addTemplate(Template t) throws IOException {
        ...
        myWriter.write(t.ID + " - " + t.language.toString() + " - " + t.templateName + " - " + t.content);
        myWriter.write("\n");
        myWriter.close();
    ...
    public Template SearchTemplate(SearchCriteria criteria) throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            templateName = data[2];
            content = data[3];
            if (equals(criteria.ID, ID) && equals(criteria.content, content) && equals(criteria.language.toString(), language) && equals(criteria.templateName, templateName)) {
